...
#
# Generated by export_simulation on Fri Jul 31 20:38:31 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Driver_UART_0.sh' script.

./Driver_UART_0.sh -reset_run
...
./Driver_UART_0.sh -noclean_files

For more information on the script, please type './Driver_UART_0.sh -help'.
