...
HD_PWD='C:/Users/13696/project_total/project_total.runs/Driver_UART_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_UART_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driver_UART_0.tcl
